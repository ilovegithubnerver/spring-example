...
public class ExampleRecord extends UpdatableRecordImpl<ExampleRecord> implements Record13<Long, String, String, String, Boolean, Integer, BigDecimal, Date, Date, Date, Long, Date, Long> {

    private static final long serialVersionUID = -1492781200;
     ...
     */
    @Override
    public Row13<Long, String, String, String, Boolean, Integer, BigDecimal, Date, Date, Date, Long, Date, Long> fieldsRow() {
     ...
     */
    @Override
    public Row13<Long, String, String, String, Boolean, Integer, BigDecimal, Date, Date, Date, Long, Date, Long> valuesRow() {
     ...
     */
    @Override
    public ExampleRecord values(Long value1, String value2, String value3, String value4, Boolean value5, Integer value6, BigDecimal value7, Date value8, Date value9, Date value10, Long value11, Date value12, Long value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ExampleRecord(Long id, String name, String code, String state, Boolean grade, Integer score, BigDecimal price, Date birth, Date sleep, Date createddate, Long createdby, Date modifieddate, Long modifiedby) {
        super(Example.EXAMPLE);
